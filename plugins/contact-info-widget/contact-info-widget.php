 ...
 * @author    Ken <khuang.dev@gmail.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2019 Red Academy (Company Name)
 *
 * @wordpress-plugin
 * Plugin Name:       Contact-Info-Widget
 * Plugin URI:        https://github.com/khuang-dev/inhabitent
 * Description:       A contact info widget for inhabitent
 * Version:           1.0.0
 * Author:            Ken
 * Author URI:        https://github.com/khuang-dev/inhabitent
 * License:           GPL-2.0+
...
class Contact_Info_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Contact info widget for Inhabitent custom theme'
			)
		);
	...
	public function form( $instance ) {
		...
		$postalcode = strip_tags( $instance['postalcode'] );
